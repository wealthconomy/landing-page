...
export function AboutHero() {
  return (
    <section className="relative overflow-hidden pt-8 pb-6 lg:pt-10 lg:pb-8">
      {/* Background Glow */}
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs font-bold uppercase tracking-[0.2em] text-foreground backdrop-blur-xl">
