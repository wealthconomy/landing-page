...
function PhoneFrame({
  ...
  return (
    <div className={className}>
      <div className="relative aspect-[9/19.5] w-full rounded-[1.5rem] lg:rounded-[2.5rem] bg-neutral-900 p-[4px] sm:p-[6px] shadow-[0_30px_70px_-20px_rgba(21,93,95,0.45)] ring-1 ring-black/10 transition-transform duration-700 hover:-translate-y-4 hover:shadow-[0_40px_80px_-20px_rgba(21,93,95,0.6)] cursor-pointer">
        <div className="absolute inset-0 rounded-[1.5rem] lg:rounded-[2.5rem] ring-1 ring-inset ring-white/10 pointer-events-none" />
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="mt-0.5 text-base font-black tracking-tight text-white">
          {value}
        </div>
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      smoothScrollYRef.current +=
        (scrollYRef.current - smoothScrollYRef.current) * lerpFactor;
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        {/* Base Grid */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:40px_40px] bg-[position:center_top] [mask-image:radial-gradient(ellipse_80%_80%_at_50%_0%,#000_20%,transparent_100%)]" />
        ...
        <div className="absolute inset-0 overflow-hidden [mask-image:radial-gradient(ellipse_80%_80%_at_50%_0%,#000_30%,transparent_100%)]">
          ...
          <div className="absolute left-[calc(50%-220px)] top-0 bottom-0 w-[1px]">
            <div
              className="w-full h-[250px] bg-gradient-to-b from-transparent via-white/30 to-transparent"
              style={{ animation: "beam-vertical 5s linear infinite" }}
            />
          </div>
          <div className="absolute left-[calc(50%+180px)] top-0 bottom-0 w-[1px]">
            <div
              className="w-full h-[200px] bg-gradient-to-b from-transparent via-gold/80 to-transparent"
              style={{ animation: "beam-vertical 7s linear infinite 2s" }}
            />
          </div>
          <div className="absolute left-[calc(50%-420px)] top-0 bottom-0 w-[1px]">
            <div
              className="w-full h-[300px] bg-gradient-to-b from-transparent via-emerald-400/80 to-transparent"
              style={{ animation: "beam-vertical 6s linear infinite 1s" }}
            />
          </div>
          ...
          <div className="absolute top-[160px] left-0 right-0 h-[1px]">
            <div
              className="h-full w-[350px] bg-gradient-to-r from-transparent via-white/30 to-transparent"
              style={{ animation: "beam-horizontal 6s linear infinite 0.5s" }}
            />
          </div>
          <div className="absolute top-[360px] left-0 right-0 h-[1px]">
            <div
              className="h-full w-[400px] bg-gradient-to-r from-transparent via-gold/80 to-transparent"
              style={{ animation: "beam-horizontal 8s linear infinite 3s" }}
            />
          </div>
        </div>

        {/* Darkening Center Gradient for extra depth */}
        <div className="absolute left-1/2 top-0 -translate-x-1/2 w-[800px] h-[500px] bg-black/30 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pt-12 lg:pt-20 pb-12 lg:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <h1
              className="animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both mt-6 font-display text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-bold leading-[1.15] tracking-tight text-white"
              style={{ animationDelay: "150ms" }}
            >
              Wealthconomy, <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold via-yellow-200 to-gold">
                Where your Money Grows into Wealth
              </span>
            </h1>

            <p
              className="animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both mt-4 max-w-xl text-base md:text-lg text-white/80 font-medium"
              style={{ animationDelay: "300ms" }}
            >
              Your platform to Save, Invest, Learn, <br />Achieve your Financial goals
              and Impact Lives.
            </p>

            <div
              className="animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both mt-6 flex flex-wrap justify-center lg:justify-start gap-4"
            ...
            >
              ...
              >
                <a
                  href="https://chat.whatsapp.com/LTUgZfloaYK8KcXB2yVkdy?mode=gi_t"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Join our community
          ...
          <div className="relative flex justify-center lg:justify-end animate-in fade-in zoom-in-95 duration-1000 delay-300 -mt-2 lg:mt-0 lg:translate-x-8 xl:translate-x-12">
            ...
            {/* Behind glows */}
            <div
              className="pointer-events-none absolute top-1/2 left-1/2 h-[400px] w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gold/15 blur-[100px] animate-pulse"
